"""
Shared Tool Handlers for MCP Apps

All 26 tool handlers extracted for reuse across multiple MCP app servers.
Each handler is a pure async function that calls the FastAPI backend.
"""
...
# ========================================
# HTTP CLIENT - SHARED ACROSS ALL APPS
# ========================================

def create_http_client(base_url: str, timeout: float = 30.0) -> httpx.AsyncClient:
    """Create shared HTTP client for FastAPI backend calls."""
...
async def handle_create_transcript(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_analyze_transcript(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_create_action_plan(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_extract_workflows(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_approve_workflow(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_execute_workflow(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_list_transcripts(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_transcript(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_analysis(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_action_plan(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_list_analyses(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_analysis_by_id(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_plan_by_id(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_plan_by_transcript(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_workflow(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_list_workflows(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_execution_status(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_list_executions(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_execution_statistics(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_dashboard_metrics(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_workflow_steps(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_execute_workflow_step(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_step_status(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_run_orchestration(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_get_orchestration_status(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
async def handle_list_orchestration_runs(http_client: httpx.AsyncClient, args: Dict[str, Any]) -> str:
...
HANDLER_REGISTRY = {
    "create_transcript": handle_create_transcript,
    "analyze_transcript": handle_analyze_transcript,
    "create_action_plan": handle_create_action_plan,
    "extract_workflows": handle_extract_workflows,
    "approve_workflow": handle_approve_workflow,
    ...
    "get_action_plan": handle_get_action_plan,
    "list_analyses": handle_list_analyses,
    "get_analysis_by_id": handle_get_analysis_by_id,
    "get_plan_by_id": handle_get_plan_by_id,
    "get_plan_by_transcript": handle_get_plan_by_transcript,
    "get_workflow": handle_get_workflow,
    "list_workflows": handle_list_workflows,
    "get_execution_status": handle_get_execution_status,
    "list_executions": handle_list_executions,
    "get_execution_statistics": handle_get_execution_statistics,
    "get_dashboard_metrics": handle_get_dashboard_metrics,
    "get_workflow_steps": handle_get_workflow_steps,
    "execute_workflow_step": handle_execute_workflow_step,
    "get_step_status": handle_get_step_status,
    "run_orchestration": handle_run_orchestration,
    "get_orchestration_status": handle_get_orchestration_status,
    "list_orchestration_runs": handle_list_orchestration_runs,
}
