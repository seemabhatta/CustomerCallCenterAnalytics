...
class WorkflowService:
    ...
    def __init__(self, db_path: str):
        ...
        self.step_agent = WorkflowStepAgent()
    ...
    async def generate_steps_for_action(self, action_item: Dict[str, Any],
        ...
        """
        return await self.step_agent.generate_steps_for_action(action_item, workflow_type, context)
    ...
    async def extract_workflow_from_plan(self, plan_id: str) -> Dict[str, Any]:
        ...
        required_fields = ['workflow_steps', 'complexity_assessment', 'dependencies', 'execution_risks', 'estimated_duration']
