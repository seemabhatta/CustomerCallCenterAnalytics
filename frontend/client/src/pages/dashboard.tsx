    ...
    <div className="p-6 max-w-screen-2xl mx-auto space-y-6" data-testid="dashboard-page">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-4">
          <div className="rounded-2xl border border-border p-4 text-center bg-card" title="Stage 1 – Transcript ingestion">
          ...
          <div className="rounded-2xl border border-border p-4 text-center bg-card" title="Stage 2 – AI analysis">
          ...
          <div className="rounded-2xl border border-border p-4 text-center bg-card" title="Stage 3 – Plan generation">
          ...
          <div className="rounded-2xl border border-border p-4 text-center bg-card" title="Stage 4 – Human approval">
          ...
          <div className="rounded-2xl border border-border p-4 text-center bg-card" title="Stage 5 – Automated execution">
